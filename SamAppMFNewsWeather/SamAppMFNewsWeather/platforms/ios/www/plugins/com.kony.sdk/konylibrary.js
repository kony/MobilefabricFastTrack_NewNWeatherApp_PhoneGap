cordova.define("com.kony.sdk.konylibrary", function(require, exports, module) { if (typeof(kony) === "undefined") {
	kony = {};
}
...
if (typeof(kony.timer) === "undefined") {
	kony.timer = {};
}

if (typeof(kony.os.deviceInfo) === "undefined") {
	kony.os.deviceInfo = {};
}

	kony.type = function(value){
		return typeof(value);
	}
	
	kony.print = function(value){
		console.log(value);
	}
	
	kony.os.deviceInfo.name = "Nexus4";
	kony.os.deviceInfo.model = "Nexus";
	kony.os.deviceInfo.version = "Kitkat";
	kony.os.userAgent = "arvind";
	kony.os.deviceInfo.deviceid = "1234567890";
...
//not a actual implementation, for purpose of kony sync framework only
kony.timer.schedule = function(timerid, functionObj, interval, repeat){
	if(typeof(interval) === "number"){
		interval = interval * 1000;
	}
    setTimeout(functionObj,interval);    
}
